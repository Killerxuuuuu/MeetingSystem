...
class ManualDiarizer:
    ...
    def run(self, audio_path, num_speakers=config.NUM_SPEAKERS):
        ...
        print(f"[Step 1] Starting Sliding Window Feature Extraction (Total Duration: {total_samples/fs:.2f}s)...")
        ...
        print(f"[Step 2] Performing Spectral Clustering (Target Speakers: {num_speakers})...")
